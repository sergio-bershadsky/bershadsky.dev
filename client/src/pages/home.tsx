      ...
      <section className="py-8 relative z-20 border-b border-white/5">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-4 relative">
            <div className="flex items-center justify-between text-sm font-mono h-5">
              {hasActiveFilters ? (
                <>
          ...
          {isLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Link key={post.id} href={`/blog/${post.slug || post.id}`} className="block group" data-testid={`card-blog-${post.slug || post.id}`}>
                ...
                >
                  <div className="mb-6 relative overflow-hidden rounded border border-white/10 aspect-video bg-black/40 transition-colors">
                     {post.imageUrl && (
                       <img 
                         src={post.imageUrl} 
                         alt={post.title}
