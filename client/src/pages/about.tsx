...
const OdooBadge = () => (
  <div 
    dangerouslySetInnerHTML={{
      __html: `<div id=o><style>@import"https://use.typekit.net/kmj5qkr.css";:root{--h:polygon(50% 0,100% 24%,100% 76%,50% 100%,0 76%,0 24%)}.oh{display:inline-block;background:#a24689;padding:3px;clip-path:var(--h)}.oa{width:100px;padding:12px 0 20px;display:flex;flex-direction:column;align-items:center;gap:4px;color:#fff;text-align:center;background:linear-gradient(153deg,#714B67 18%,#5a3d54 40%,#3d2a3a 80%);clip-path:var(--h);box-shadow:0 14px 25px rgba(113,75,103,.35)}#o{font-family:proxima-nova,Arial,sans-serif}.ob{margin:0;font-size:10px;font-weight:700;line-height:1}.oc{width:60px;height:1px;background:#a24689}.od{font-size:8px;opacity:.8;margin-bottom:-3px}</style><div class=oh><div class=oa><svg width=32 viewBox="0 0 60 17" xmlns="http://www.w3.org/2000/svg"><path d="m20.85 6.38 6.06-.89 2.72-5.49 2.71 5.49 6.06.89-4.39 4.28 1.04 6.03-5.42-2.85-5.43 2.85 1.04-6.03zm33.06 7.17 1.85-.27.82-1.67.83 1.67 1.84.27-1.33 1.31.31 1.83-1.65-.87-1.66.87.32-1.83zm-3.38-3.01-3.61-.52-1.61-3.26-1.62 3.26-3.6.52 2.6 2.55-.61 3.59 3.23-1.69 3.21 1.69-.61-3.59zm-45.19 3.01-1.85-.27-.82-1.67-.83 1.67-1.84.27 1.33 1.31-.31 1.83 1.65-.87 1.65.87-.31-1.83zm3.38-3.01 3.61-.52 1.61-3.26 1.61 3.26 3.61.52-2.6 2.55.61 3.59-3.23-1.69-3.22 1.69.62-3.59z" fill="#fff"/></svg><h3 class=ob>CERTIFIED DEV</h3><div class=oc></div><span class=od>Odoo 18</span><svg viewBox="0 0 100 28" width="50" xmlns="http://www.w3.org/2000/svg"><text x="50" y="20" text-anchor="middle" fill="#fff" font-family="Arial,sans-serif" font-size="22" font-weight="bold">odoo</text></svg></div></div></div>`
    }}
  />
);
