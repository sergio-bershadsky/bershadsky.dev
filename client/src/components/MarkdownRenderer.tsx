...
export { CyberCodeBlock, ChatConversationDiagram } from './markdown/CodeBlock';
export { DiagramBox, DiagramFrame, TwoColumnComparison, StepList, IconRow, FolderTree, ScrollableDiagram } from './markdown/primitives';
export { 
  registerDiagram, 
  registerDiagrams, 
  findDiagram, 
